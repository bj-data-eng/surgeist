...
pub struct AppLoop<State = (), Reducer = (), Input = (), Handler = ()> {
    ...
    native_loop: Option<crate::window::Loop<Handler>>,
}
...
impl<State, Reducer, Input, Handler> AppLoop<State, Reducer, Input, Handler> {
    ...
    pub fn with_native_loop(
        runtime: Runtime<State, Reducer, Input>,
        native_loop: crate::window::Loop<Handler>,
    ) -> Self {
        Self {
            runtime,
    ...
    #[must_use]
    pub const fn native_loop(&self) -> Option<&crate::window::Loop<Handler>> {
        self.native_loop.as_ref()
    }

    pub fn native_loop_mut(&mut self) -> Option<&mut crate::window::Loop<Handler>> {
