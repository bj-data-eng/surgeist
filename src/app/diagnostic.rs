...
impl Diagnostic {
    ...
    #[must_use]
    pub fn with_window(mut self, id: crate::window::Id) -> Self {
    ...
    #[must_use]
    pub const fn window_id(&self) -> Option<crate::window::Id> {
        self.window_id
    }
...
impl DiagnosticLog {
    ...
    pub fn entry_refs(&self) -> impl Iterator<Item = &Diagnostic> {
        self.entries.iter()
    }
