...
macro_rules! property_schema {
    ($callback:ident, $input:ident, $numeric:ident) => {
        $callback! {
            ...
            Width, "width", [], "baseline.property.width", CssLength, CssWidthPropertyValue, CssWidthPropertyValueRepresentation, parse_box_size_value, { parse_box_size_value($input, $numeric)? };
            Height, "height", [], "baseline.property.height", CssLength, CssHeightPropertyValue, CssHeightPropertyValueRepresentation, parse_box_size_value, { parse_box_size_value($input, $numeric)? };
            MinWidth, "min-width", [], "baseline.property.min-width", CssLength, CssMinWidthPropertyValue, CssMinWidthPropertyValueRepresentation, parse_box_size_value, { parse_box_size_value($input, $numeric)? };
            MinHeight, "min-height", [], "baseline.property.min-height", CssLength, CssMinHeightPropertyValue, CssMinHeightPropertyValueRepresentation, parse_box_size_value, { parse_box_size_value($input, $numeric)? };
            MaxWidth, "max-width", [], "baseline.property.max-width", CssLength, CssMaxWidthPropertyValue, CssMaxWidthPropertyValueRepresentation, parse_box_size_value, { parse_box_size_value($input, $numeric)? };
            MaxHeight, "max-height", [], "baseline.property.max-height", CssLength, CssMaxHeightPropertyValue, CssMaxHeightPropertyValueRepresentation, parse_box_size_value, { parse_box_size_value($input, $numeric)? };
            ...
            Margin, "margin", [], "baseline.property.margin", CssEdges, CssMarginPropertyValue, CssMarginPropertyValueRepresentation, parse_edges, { parse_edges($input, |input| parse_margin_component(input, $numeric))? }, expansion = shorthand { wrapper: fallback, accessor: current, members: [ MarginTop => |value: &CssEdges| Some(value.top.clone()), MarginRight => |value: &CssEdges| Some(value.right.clone()), MarginBottom => |value: &CssEdges| Some(value.bottom.clone()), MarginLeft => |value: &CssEdges| Some(value.left.clone()) ], reset_only: [] };
            MarginTop, "margin-top", [], "baseline.property.margin-top", CssLength, CssMarginTopPropertyValue, CssMarginTopPropertyValueRepresentation, parse_margin_component, { parse_margin_component($input, $numeric)? }, expansion = longhand { wrapper: fallback, value: CssLength, accessor: current, inherited: false, initial_kind: value, initial: CssLength::Zero };
            MarginRight, "margin-right", [], "baseline.property.margin-right", CssLength, CssMarginRightPropertyValue, CssMarginRightPropertyValueRepresentation, parse_margin_component, { parse_margin_component($input, $numeric)? }, expansion = longhand { wrapper: fallback, value: CssLength, accessor: current, inherited: false, initial_kind: value, initial: CssLength::Zero };
            MarginBottom, "margin-bottom", [], "baseline.property.margin-bottom", CssLength, CssMarginBottomPropertyValue, CssMarginBottomPropertyValueRepresentation, parse_margin_component, { parse_margin_component($input, $numeric)? }, expansion = longhand { wrapper: fallback, value: CssLength, accessor: current, inherited: false, initial_kind: value, initial: CssLength::Zero };
            MarginLeft, "margin-left", [], "baseline.property.margin-left", CssLength, CssMarginLeftPropertyValue, CssMarginLeftPropertyValueRepresentation, parse_margin_component, { parse_margin_component($input, $numeric)? }, expansion = longhand { wrapper: fallback, value: CssLength, accessor: current, inherited: false, initial_kind: value, initial: CssLength::Zero };
            Padding, "padding", [], "baseline.property.padding", CssEdges, CssPaddingPropertyValue, CssPaddingPropertyValueRepresentation, parse_edges, { parse_edges($input, |input| parse_padding_component(input, $numeric))? }, expansion = shorthand { wrapper: fallback, accessor: current, members: [ PaddingTop => |value: &CssEdges| Some(value.top.clone()), PaddingRight => |value: &CssEdges| Some(value.right.clone()), PaddingBottom => |value: &CssEdges| Some(value.bottom.clone()), PaddingLeft => |value: &CssEdges| Some(value.left.clone()) ], reset_only: [] };
            PaddingTop, "padding-top", [], "baseline.property.padding-top", CssLength, CssPaddingTopPropertyValue, CssPaddingTopPropertyValueRepresentation, parse_padding_component, { parse_padding_component($input, $numeric)? }, expansion = longhand { wrapper: fallback, value: CssLength, accessor: current, inherited: false, initial_kind: value, initial: CssLength::Zero };
            PaddingRight, "padding-right", [], "baseline.property.padding-right", CssLength, CssPaddingRightPropertyValue, CssPaddingRightPropertyValueRepresentation, parse_padding_component, { parse_padding_component($input, $numeric)? }, expansion = longhand { wrapper: fallback, value: CssLength, accessor: current, inherited: false, initial_kind: value, initial: CssLength::Zero };
            PaddingBottom, "padding-bottom", [], "baseline.property.padding-bottom", CssLength, CssPaddingBottomPropertyValue, CssPaddingBottomPropertyValueRepresentation, parse_padding_component, { parse_padding_component($input, $numeric)? }, expansion = longhand { wrapper: fallback, value: CssLength, accessor: current, inherited: false, initial_kind: value, initial: CssLength::Zero };
            PaddingLeft, "padding-left", [], "baseline.property.padding-left", CssLength, CssPaddingLeftPropertyValue, CssPaddingLeftPropertyValueRepresentation, parse_padding_component, { parse_padding_component($input, $numeric)? }, expansion = longhand { wrapper: fallback, value: CssLength, accessor: current, inherited: false, initial_kind: value, initial: CssLength::Zero };
            ...
            Opacity, "opacity", [], "baseline.property.opacity", CssOpacity, CssOpacityPropertyValue, CssOpacityPropertyValueRepresentation, parse_opacity, { parse_opacity($input, $numeric)? };
