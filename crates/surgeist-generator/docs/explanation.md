...
This workspace crate owns its implementation, public API, focused tests, and
documentation. Production corpora and generated expectations belong to its
consuming crates; acquired source trees and browser installations are not
committed. Root `surgeist` owns workspace composition, cross-crate adapters,
integration tests, and the API generator and generated API audit artifacts.
